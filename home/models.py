...
class Conta(models.Model):
    ...
    tipo_de_conta = models.CharField(max_length=2,choices=TIPO_CONTA,verbose_name='Tipo de conta')
...
class Cartao(models.Model):
    ...
    bandeira = models.CharField(max_length=10,choices=BANDEIRA,verbose_name="Bandeira")
...
class Extrato(Model):
    ...
    conta = ForeignKey(Conta,on_delete=CASCADE,verbose_name="Conta")
    operacao = CharField(max_length=1,choices=OPERACAO,verbose_name="Operação")
